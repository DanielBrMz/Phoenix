  ...
  return (
    <section className="relative flex w-full flex-col items-center justify-center px-4 py-8 md:px-0">
      ...
      <Wrapper className="relative flex flex-col items-center justify-center py-12">
        ...
        <div className="absolute -left-1/3 bottom-0 z-20 hidden h-72 w-72 rounded-full bg-orange-500 blur-[10rem] md:block"></div>
      ...
      {/* pricing */}
      <Wrapper className="relative flex flex-col items-center justify-center py-12">
        <div className="absolute -right-1/3 top-0 z-20 hidden h-72 w-72 rounded-full bg-orange-500 blur-[10rem] md:block"></div>
        <div className="mx-auto max-w-md text-start md:text-center">
      ...
      {/* testimonials */}
      <Wrapper className="relative flex flex-col items-center justify-center py-12">
        <div className="absolute -left-1/3 -top-1/4 z-20 hidden h-72 w-72 rounded-full bg-orange-500 blur-[10rem] md:block"></div>
        <div className="mx-auto max-w-md text-start md:text-center">
